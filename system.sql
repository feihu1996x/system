...
CREATE TABLE `qq_group` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'qq/微信群id',
  `group_name` varchar(100) NOT NULL DEFAULT '' COMMENT 'QQ/微信群名称',
  `group_number` varchar(100) NOT NULL DEFAULT '暂无' COMMENT 'QQ/微信群号码',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='QQ/微信群表';

DROP TABLE IF EXISTS `original_messages`;

CREATE TABLE `original_messages` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '消息id',
  `group_id` varchar(100) NOT NULL DEFAULT '' COMMENT 'QQ/微信群id',
  `sender_name` varchar(100) NOT NULL DEFAULT '' COMMENT '用户昵称',
  `qq_number` varchar(100) NOT NULL DEFAULT '' COMMENT 'QQ/微信号',
...
CREATE TABLE `second_filter_qqnumber` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `qq_number` varchar(100) NOT NULL DEFAULT '' COMMENT 'QQ/微信号码',
  `updated_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后一次更新时间',
  `created_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '插入时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `qq_number` (`qq_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='二次过滤QQ/微信号表';
